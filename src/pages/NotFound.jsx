...
const NotFound = () => {
  return (
    <div
      className="flex items-center justify-center min-h-dvh w-dvw bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden "
      dir="rtl"
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-2xl">
        ...
        <div className="relative mb-8">
          <h1 className="text-[180px] md:text-[240px] font-black text-transparent bg-clip-text bg-linear-to-b from-teal-500 to-teal-600 leading-none select-none">
            404
          </h1>
